...
| Заказчик | `company` выбранной заявки или пусто |
| Контакты заказчика | `company_contacts` выбранной заявки или пусто |
| Автор заявки | ФИО из `author_lastname` / `author_firstname` / `author_middlename` или пусто |
