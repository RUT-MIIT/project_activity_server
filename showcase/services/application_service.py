...
class ProjectApplicationService:
    ...
    def request_changes(self, application_id: int, requester: User):
        ...
        is_user_department_involved = self._is_user_department_involved(application, requester)
        is_user_author = application.author == requester if application.author else False
    ...
    def approve_application(self, application_id: int, approver: User):
        ...
        is_user_department_involved = self._is_user_department_involved(application, approver)
    ...
    def reject_application(self, application_id: int, rejector: User, reason: str = ""):
        ...
        is_user_department_involved = self._is_user_department_involved(application, rejector)
        ...
        if rejected_status_code in ['rejected_department', 'rejected_institute', 'rejected_cpds']:
    ...
    def update_application(
        ...
        is_user_department_involved = self._is_user_department_involved(application, updater)
    ...
    def get_user_in_work_applications(self, user: User):
        ...
        if user_role in ['department_validator', 'institute_validator']:
            if hasattr(user, 'department') and user.department:
                department_applications = self.repository.filter_in_work_by_department(user.department)
    ...
    def get_available_actions(self, application_id: int, user: User) -> AvailableActionsDTO:
        ...
        is_user_department_involved = self._is_user_department_involved(application, user)
    ...
    def _get_approved_status_code(self, user_role: str) -> str:
        ...
        if user_role == 'department_validator':
            ...
            # Для других ролей - approved по умолчанию
            return 'approved'
