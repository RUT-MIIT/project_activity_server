...
class InvolvedManager:
    ...
    def remove_involved_user(
        application: ProjectApplication, user: User, actor: User | None = None
    ) -> int:
    ...
    @staticmethod
    @transaction.atomic
    def add_involved_department(
        application: ProjectApplication, department, actor: User | None = None
    ) -> ApplicationInvolvedDepartment:
