...
class InvolvedManagementService:
    ...
    def add_user_and_departments(
        ...
        if user.department:
            department_added = self._add_involved_department(application, user.department, actor)
            if department_added:
    ...
    def get_involved_users(self, application: ProjectApplication) -> List[User]:
        ...
        """
        return [
            involved.user for involved in 
            application.involved_users.select_related('user').all()
        ]
    
    def get_involved_departments(self, application: ProjectApplication) -> List['Department']:
        """
        ...
        """
        return [
            involved.department for involved in 
            application.involved_departments.select_related('department').all()
        ]
    ...
    def remove_involved_department(
        ...
        """
        involved_department = application.involved_departments.filter(department=department).first()
